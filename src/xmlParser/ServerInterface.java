...
public enum ServerInterface {
	...
	public String getDepartureFlightFromAirPort (String teamName, String airportCode, LocalDate date) {
		...
		try {
			 ...
			 */
			url = new URL(mUrlBase + QueryFactory.getDepartureFlightFromAirPort(teamName, airportCode, date));
	...
	public void TicketDeduction (String teamName, Leg leg, String ticketClass) {
		URL url;
		HttpURLConnection connection;
		...
		try {
			...
			String params = QueryFactory.buyTicket(teamName, leg, ticketClass);
